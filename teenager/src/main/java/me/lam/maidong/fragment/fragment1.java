...
public class fragment1 extends LazFragment {
    ...
    static int roundnum = 30;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        Log.e("time", "onCreateView1");

        View view = inflater.inflate(R.layout.fragment_mai_dong_datashow1, null);
        return view;
    }
